...
class PyInterfaceTests(unittest.TestCase):
    ...
    def test_stability_check_py_interface(self):
        ...
        if wrong_min_eigval:
            print(
                " test_stability_check_py_interface failed: Returned minimum "
                "eigenvalue wrong."
                ""
            )
...
class CSystemTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        print_separator("Running system tests for C interface...")
        return super().setUpClass()
...
class PySystemTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        print_separator("Running system tests for Python interface...")
        return super().setUpClass()
    ...
    def test_stability_check_py(self):
        ...
        stable, _ = stability_check(h_diag, hess_x, self.n_param, settings, kappa=kappa)
        if not stable:
            print(
