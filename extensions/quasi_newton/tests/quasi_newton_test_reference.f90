...
contains
    ...
    subroutine get_default_qn_values(default_values_out) bind(C)
        !
        ...
        type(qn_settings_type_c), intent(out) :: default_values_out

        default_values_out = default_qn_settings

    end subroutine get_default_qn_values
