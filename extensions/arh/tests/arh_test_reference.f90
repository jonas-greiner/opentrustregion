...
module otr_arh_test_reference
    ...
    ! number of AOs
    integer(ip), parameter :: n_ao = 3_ip
    integer(c_ip), parameter :: n_ao_c = int(n_ao, kind=c_ip)
    ...
    type(ref_arh_settings_type) :: ref_arh_settings = ref_arh_settings_type(verbose = 3)
...
contains
    ...
    function test_get_energy_funptr(get_energy_funptr, test_name, message) &
        result(test_passed)
        !
        ! this function tests a provided energy function pointer
        !
    ...
    end function test_get_energy_funptr
    ...
    function test_get_energy_c_funptr(get_energy_c_funptr, test_name, message) &
        result(test_passed)
        !
        ! this function tests a provided energy C function pointer
        !
    ...
    end function test_get_energy_c_funptr
    ...
    subroutine assign_ref_to_arh_c(lhs_c, rhs)
        !
        ! this subroutine overloads the assignment operator to set C ARH 
    ...
    logical function equal_arh_to_ref(lhs, rhs)
        !
        ! this function overloads the comparison operator to compare ARH settings 
        ! to reference values
        !
        use otr_arh, only: arh_settings_type
        ...
        equal_arh_to_ref = lhs%verbose == rhs%verbose
    ...
    logical function not_equal_arh_to_ref(lhs, rhs)
        ...
        ! ARH settings to reference values
        !
        use otr_arh, only: arh_settings_type
    ...
    logical function equal_arh_c_to_ref(lhs_c, rhs)
        !
        ! this function overloads the comparison operator to compare ARH 
        ! settings to reference values
        !
        use otr_arh_c_interface, only: arh_settings_type_c, assignment(=)
        use otr_arh, only: arh_settings_type
    ...
    logical function equal_arh(lhs, rhs)
        ...
        equal_arh = lhs%verbose == rhs%verbose
    ...
    logical function not_equal_arh(lhs, rhs)
        !
        ! this function overloads the negated comparison operator to compare 
        ! ARH settings to different ARH settings
        !
        use otr_arh, only: arh_settings_type
