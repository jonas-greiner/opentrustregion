...
module otr_arh_c_interface_mock
    ...
    use otr_arh_test_reference, only: ref_arh_settings, n_ao
...
contains
    ...
    function mock_arh_factory_c_wrapper(dm_ao_c, ao_overlap_c, n_ao_c, &
        ...
        use otr_arh_c_interface, only: get_energy_c_type, get_fock_c_type, &
                                       arh_settings_type_c
        use c_interface, only: obj_func_c_type, update_orbs_c_type, hess_x_c_type, &
                               precond_c_type, logger_c_type
        use test_reference, only: tol_c
        use otr_arh_test_reference, only: test_get_energy_c_funptr, &
                                          test_get_fock_c_funptr, operator(/=)
    ...
    function mock_arh_deconstructor_c_wrapper(dm_ao_c) result(error_c) &
        bind(C, name="mock_arh_deconstructor")
        !
    ...
    end function mock_arh_deconstructor_c_wrapper
