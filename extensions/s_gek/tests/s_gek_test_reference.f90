...
contains
    ...
    subroutine get_default_s_gek_values(default_values_out) bind(C)
        !
        ...
        type(s_gek_settings_type_c), intent(out) :: default_values_out

        default_values_out = default_s_gek_settings

    end subroutine get_default_s_gek_values
